...
contract OcxLocalPool {
    ...
    function getAmountsOut(
        ...
        if (ret1 && ret2) {
            ...
            require(ethPoolBalance > newPoolEthBalance, "getAmountsOut(): -7");
