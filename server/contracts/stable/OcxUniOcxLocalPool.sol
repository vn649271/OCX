...
contract OcxUniOcxLocalPool is OcxBase {
    ...
    Pool                public      localPool; // token pair: 0: UNI, 1: OCX
    ...
    onlyAdmin returns(uint256 amountOut)
    {
        ...
        require(allowance >= amountIn, "OcxLocalPool.addLiquidity(): Insufficient allowance for UNI");
    ...
    /*
     * Parameters:
     *      amountPair: amount of UNI/OCX token pair
     */
    function addLiquidity(
        uint256[2] memory amountPair
    ) public payable 
    onlyAdmin {
        require(ocatAddress != address(0), "Invalid UNI address");
        ...
        require(allowance >= amountPair[0], "OcxLocalPool.addLiquidity(): Insufficient allowance for UNI");
