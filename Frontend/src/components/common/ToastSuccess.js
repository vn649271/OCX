...
export default function ToastSuccess(props) {
	...
	useEffect(() => {
		...
		setTimeout(() => {
			console.log("ToastSucess.componentDidMount() called");
		}, 4000);
	});

    return (
		<div id="toast-success" className="flex items-center w-full p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 floating-box" role="alert">
		    ...
		    <div className="ml-3 main-font font-normal text-green-500">{props.message}</div>
