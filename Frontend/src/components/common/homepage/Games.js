            ...
            <div className="small-container">
                <div className="games-box text-center">
                    ...
                    <div className="main-lineheight pb-10">
                        <p className="main-font font-24 text-center main-lineheight">We are the payment gateway for you to pay or receive cryptos using us to play games or buying or sign in everyday to try your luck.</p>
                    </div>
                    <div className="games-card_box flex justify-center">
                        ...
                        <div className="game-card home-card w-1/3 transform-card-r mx-10">
                            ...
                            <div className="main-btn blue-border w-full main-font button-bg hover-transition flex items-center justify-center text-white">
                                Buy Tickets
                                <span className="text-white">
                                    <svg viewBox="0 0 24 24" color="" width="20px" xmlns="http://www.w3.org/2000/svg" className="sc-bdnxRM cetRDm text-white"><path d="M5 13H16.17L11.29 17.88C10.9 18.27 10.9 18.91 11.29 19.3C11.68 19.69 12.31 19.69 12.7 19.3L19.29 12.71C19.68 12.32 19.68 11.69 19.29 11.3L12.71 4.7C12.32 4.31 11.69 4.31 11.3 4.7C10.91 5.09 10.91 5.72 11.3 6.11L16.17 11H5C4.45 11 4 11.45 4 12C4 12.55 4.45 13 5 13Z"></path></svg>
                                </span>
                            </div>
                        </div>
                    </div>
